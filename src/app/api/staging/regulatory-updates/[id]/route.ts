/**
 * PATCH /api/staging/regulatory-updates/[id]
 *
...
import { updateRegulatoryUpdateDraft } from '@/lib/services/staging-writes';
...
export async function PATCH(
  ...
  return resolveSession(async () => {  
    try {
      ...
      const result = await updateRegulatoryUpdateDraft(id, body);
      ...
      console.error('[API] PATCH /api/staging/regulatory-updates/[id] error:', err);
